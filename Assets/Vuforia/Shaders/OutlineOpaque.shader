...
Shader "Custom/OutlineOpaque" {
    Properties { _SilhouetteSize("Size", Float) = 0.0 _SilhouetteColor("Color", Color) = (1, 1, 1, 1) }
...
#pragma fragment frag
            ...
            half4 frag(v2f input) : COLOR { return input.color; }
            ENDCG
        }
    }
