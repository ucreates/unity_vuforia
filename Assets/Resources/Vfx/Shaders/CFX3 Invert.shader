...
Shader "Cartoon FX/Particle Invert" {
    Properties {
        _TintColor("Tint Color", Color) = (0.5, 0.5, 0.5, 0.5)_MainTex("Particle Texture", 2D) = "white" {}
    ...
    Category {
        ...
        Blend OneMinusDstColor OneMinusSrcColor ColorMask RGB Cull Off Lighting Off ZWrite Off Fog { Color(0, 0, 0, 0) }
