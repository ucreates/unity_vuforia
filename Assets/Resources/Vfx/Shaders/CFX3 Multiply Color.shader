...
Shader "Cartoon FX/Particle Multiply Colored" {
    Properties {
        _TintColor("Tint Color", Color) = (0.5, 0.5, 0.5, 0.5)_MainTex("Particle Texture (alpha)", 2D) = "white" {}
    ...
    Category {
        ...
        Blend DstColor Zero AlphaTest Greater .01 ColorMask RGB Cull Off Lighting Off ZWrite Off Fog { Color(0, 0, 0, 0) }
