...
public class MtlAssetDiffuseParser : MtlAssetBaseParser<MtlAssetDiffuseFormat> {
    public override MtlAssetDiffuseFormat Read(string header, string body) {
        ...
        MtlAssetDiffuseFormat format = new MtlAssetDiffuseFormat();
