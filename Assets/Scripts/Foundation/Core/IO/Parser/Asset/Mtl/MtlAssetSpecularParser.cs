...
public class MtlAssetSpecularParser : MtlAssetBaseParser<MtlAssetSpecularFormat> {
    public override MtlAssetSpecularFormat Read(string header, string body) {
        ...
        MtlAssetSpecularFormat format = new MtlAssetSpecularFormat();
